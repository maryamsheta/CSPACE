...
public class GuessTheLanguageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guess_the_language);
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM guessTheLanguage ORDER BY RANDOM() LIMIT 1", null);
    ...
    public void onClick(View view)
    {
        ...
        switch (view.getId()) {
            ...
            case R.id.playAgain:
                Intent playAgain = new Intent(this,GuessTheLanguageActivity.class);
